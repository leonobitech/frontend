...
export default function LabWsAuthPage() {
  ...
  const getTicket = async (): Promise<string | null> => {
    ...
    const r = await fetch("/api/lab/01-ws-auth", {
      method: "POST",
  ...
  return (
    <div className="font-sans p-6 max-w-3xl mx-auto">
      <h1 className="text-2xl font-bold mb-3">Lab 01 — WS Auth</h1>
      <p className="mb-4 text-gray-600">
        Reutilizando el flujo existente (Core + ticket JWT + querystring). Mide
        RTT con <code>PING::timestamp</code>.
      </p>
      ...
      <div className="mt-4 grid grid-cols-[1fr_auto] gap-2">
        <input
          ...
          placeholder='Escribe un mensaje (ej: "ECHO hola" o "PING::1234")…'
