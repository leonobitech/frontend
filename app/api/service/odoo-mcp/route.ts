// app/api/service/odoo-mcp/route.ts
...
// ===== Config =====
const CORE_PATH = "/service/odoo-mcp"; // User service (no requiere admin)
const FORWARD_COOKIES = ["accessKey", "clientKey"] as const;
const REINJECT_COOKIES = ["accessKey", "clientKey"] as const;
...
export async function POST(request: Request) {
  try {
    ...
    // 7) SIEMPRE setear clientMeta para que la nueva ventana pueda pasar ForwardAuth
    // La cookie clientMeta es necesaria para que Traefik valide el request en Core
