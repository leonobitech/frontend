// ─── Rust Embedded desde Cero — Not Found ───
//
// Se dispara cuando `loadStep` retorna null — o sea, el slug no matchea con
// ningún archivo en `content/rust-embedded/`. Pasa típicamente cuando:
//   - Un paso todavía no fue sincronizado desde Notion
//   - El slug en la URL está deprecado / mal escrito

import Link from "next/link";

import { COURSE_BASE_URL, COURSE_TITLE } from "@/lib/course/steps";
