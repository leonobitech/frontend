// ─── Financial RAG Evaluation Suite — Loader de MDX por slug + locale ───
//
// Convención de filesystem:
//   ES — content/financebench/{paso-NN-...}.mdx                    (canónico)
//   EN — content/financebench/en/{step-NN-...}.mdx                  (traducción)
//
...
const CONTENT_DIR_ES = path.join(process.cwd(), "content", "financebench");
 ...
 * - Para `locale === "en"`, intenta `content/financebench/en/{step-NN-...}.mdx`
...
/**
 * Lista todos los slugs ES presentes en `content/financebench/`. Útil para
 ...
 *   fuente de verdad).
 * - Locale EN devuelve `true` solo si `content/financebench/en/{step-NN}.mdx`
 *   existe.
 */
