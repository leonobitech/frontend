...
//
// El roadmap tiene ~20 lessons agrupadas en 5 Stages (0..4). El campo
...
export const COURSE_STEPS: StepMeta[] = [
  ...
  {
    step: 4,
    slug: "paso-04-foundry-setup",
    title: "Microsoft Foundry Setup",
    titleEn: "Microsoft Foundry Setup",
    repoUrl: COURSE_REPO_URL,
    stage: 1,
  },
  {
    step: 5,
    slug: "paso-05-eval-pipeline",
    title: "Eval Pipeline",
  ...
  {
    step: 10,
    slug: "paso-10-contextual-retrieval",
  ...
  {
    step: 13,
    slug: "paso-13-tabla-maestra-parcial",
  ...
  {
    step: 14,
    slug: "paso-14-fine-tuning-design",
  ...
  {
    step: 15,
    slug: "paso-15-fine-tuning-bge-m3",
